/**
 * Created by caole on 4/15/2016.
 */
var CIRCLE = Math.PI * 2;
var MOBILE = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)

var server = 'http://192.168.1.200:3251/first_person.html';

var qrcode = new QRCode("qrcode");
var roomURL = "http://192.168.1.200:3251/first_person.html";
...
if (!MOBILE) {
	...
	socket.on("connected", function (data) {
		...
		function Player(x, y, direction) {
			...
			this.weapon = new Bitmap('f-assets/knife_hand.png', 319, 320);
			this.paces = 0;
		}
		...
		function Map(size) {
			...
			this.skybox = new Bitmap('f-assets/deathvalley_panorama.jpg', 2000, 750);
			this.wallTexture = new Bitmap('f-assets/wall_texture.jpg', 1024, 1024);
			this.light = 0;
		}
